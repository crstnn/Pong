...
function pong() {
	...
	const createBall = (
		...
		acc: Vector = Vector.Zero,
		vel: Vector = new Vector(Math.random() > 0.5 ? 3 : -3, Constants.Zero), // ball travels in random direction
	...
	// const buttClick = fromEvent<MouseEvent>(document.getElementById("restartGameButton")!, 'onclick');
	// const buttClick2 = fromEvent<KeyboardEvent>(document, 'ArrowLeft').pipe(map(console.log))
